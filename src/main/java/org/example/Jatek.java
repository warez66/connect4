...
public class Jatek {
    ...
    private boolean aiMode; // Jelzi, hogy a második játékos AI-e
    ...
    public Jatek(String jatekos1Nev, String jatekos2Nev, boolean isAI) {
        tabla = new Tabla(6, 7); // Inicializálja a 6x7-es játéktáblát
        jatekos1 = new Jatekos(jatekos1Nev, "Y", false); // Emberi első játékos
        jatekos2 = new Jatekos(jatekos2Nev, "R", isAI); // Második játékos (AI vagy ember)
        aktualisJatekos = jatekos1; // Az első játékos kezd
        this.aiMode = isAI; // Beállítja, hogy a második játékos AI-e
        gameState = new GameState(); // Inicializálja a játék állapotát
        menuHandler = new MenuHandler(this); // Menü kezelő inicializálása
    }
